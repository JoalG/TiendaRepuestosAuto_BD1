...
using WebApp_TiendaRepuestosAuto.Models;

namespace WebApp_TiendaRepuestosAuto.Controllers
{
    public class PersonasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Cedula,nombre,ID_ClientePersona")] Persona persona)
        {
